  ...
  <main class="main">
    <el-space direction="vertical">
      ...
      <div class="content">
        ...
        <el-link class="baidubaike" href="https://element-plus.org" target="_blank" icon="TopRight">百度百科</el-link>
      </div>
    </el-space>
  </main>
</template>
...
.text-1 {
  ...
  text-shadow:
    1px 1px var(--el-color-danger-dark-2),
    2px 2px var(--el-color-danger-dark-2),
